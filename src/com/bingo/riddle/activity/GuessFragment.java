...
public class GuessFragment extends Fragment implements OnCheckedChangeListener {
	...
	private void getRiddleDesById(int riddleId) {
		...
		if (riddle != null) {
			...
			riddleDes.setText("很遗憾，没有获取到歇后语。");
		}
	}
	...
	private void onClickShareTextToComputer() {
		...
		params.putString(GameAppOperation.QQFAV_DATALINE_APPNAME, "歇后语库");
	...
	private void onClickShareToQQ() {
		ThreadManager.getMainHandler().post(new Runnable() {
			...
			public void run() {
				...
				params.putString(QQShare.SHARE_TO_QQ_APP_NAME, "歇后语库");
